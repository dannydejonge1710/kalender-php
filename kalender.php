...
<html>
	...
	<body>
        ...
        <form action="kalenderuitkomst.php" method="post">

             <div id="inputs">   
                <p>Vul hier je voornaam in</p><input type="text" name="voornaam">
                <p>Vul hier je achternaam in</p><input type="text" name="achternaam">
                <p>Vul hier je e-mail adres in</p><input type="text" name="email">
            </div>
